  ...
  match({ routes: allRoutes, location: req.url }, (error, redirectLocation, renderProps) => {
    if (redirectLocation) {
      ...
      const preloaders = renderProps.components
        .filter((component) => {console.log("component123:" + component); return component && component.preload;})
        .map((component) => {console.log("params123: " + renderProps.params); return component.preload(renderProps.params, req);})
